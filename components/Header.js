...
const style = {
    ...
    nomadsText: `text-5xl font-semibold mr-8 cursor-pointer`,
    ...
    accountAddress: `ml-2`,
    authButton: `bg-red-500 font-bold text-white px-6 py-3 items-center ml-4 rounded-lg hover:bg-blue-100 duration-300 hover:text-white`,
}

const Header = () => {
  const { connectWallet, currentAccount, disconnectWallet } =
    useContext(NomadsContext)
  ...
  return (
    ...
    >
      <div className={style.main}>
        ...
        <h1 className={style.nomadsText}>Nomads connect</h1>
