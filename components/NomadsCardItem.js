...
const style = {
  nomadsCardWrapper: `w-full h-full absolute`,
...
const NomadsCardItem = ({ card }) => {
  const { handleRightSwipe, currentAccount } = useContext(NomadsContext)
  ...
  return (
    <TinderCard
      className={style.nomadsCardWrapper}
